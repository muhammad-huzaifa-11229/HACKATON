    ...
    <header>
      ...
      <div className="flex flex-wrap justify-between items-center px-6 py-4">
        ...
        <div className="flex items-center gap-4 mt-4 md:mt-0">
          ...
          <FaHeart className="text-gray-700 md:w-[24px] md:h-[24px] sm:w-[20px] sm:h-[20px] w-[16px] h-[16px] cursor-pointer hover:text-black" aria-label="Wishlist" />
          <FaShoppingBag className="text-gray-700 md:w-[24px] md:h-[24px] sm:w-[20px] sm:h-[20px] w-[16px] h-[16px] cursor-pointer hover:text-black" aria-label="Cart" />
        </div>
      </div>
